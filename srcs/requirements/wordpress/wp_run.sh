...
wp --allow-root core install --url="https://wbritni.42.fr/"  --title="Inception Project" --admin_user=${WP_ADMIN_LGN} --admin_password=${WP_ADMIN_PWD} --admin_email=${WP_ADMIN_MAIL} --skip-email
